...
class SendSubscriberUpdatedVerificationEmailHandler
{
    /**
     * The mailer instance.
     *
     ...
     * Handle the event.
     *
     * @param \CachetHQ\Cachet\Bus\Events\SubscriberHasUpdatedSubscriptionsEven $event
     *
     * @return void
     */
    public function handle(SubscriberHasUpdatedSubscriptionsEvent $event)
    {
        if($event->subscriber->getIsVerifiedAttribute()){
            return;
        }
